...
import { Users, ArrowLeft, Send, Loader2, Download, Zap } from 'lucide-react';
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-uswds-blue-5 rounded flex items-center justify-center">
                  <Users className="h-5 w-5 text-uswds-blue" />
                </div>
                <div>
                  <h1 className="text-lg font-bold text-uswds-gray-90 font-serif">Stakeholder Mapping</h1>
                </div>
              </div>
            </div>
            <button
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg border border-uswds-gray-10 p-6 sticky top-8">
              ...
              <ul className="space-y-3 text-sm text-uswds-gray-70">
                ...
                <li className="flex items-start">
                  <span className="text-uswds-blue mr-2 mt-0.5">•</span>
                  <span>Role and responsibility matrix</span>
                </li>
                <li className="flex items-start">
                  <span className="text-uswds-blue mr-2 mt-0.5">•</span>
                  <span>Influence and interest analysis</span>
                </li>
                <li className="flex items-start">
                  <span className="text-uswds-blue mr-2 mt-0.5">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-uswds-blue mr-2 mt-0.5">•</span>
                  <span>Approval chain mapping</span>
                </li>
                <li className="flex items-start">
                  <span className="text-uswds-blue mr-2 mt-0.5">•</span>
                  <span>Risk and issue escalation paths</span>
                </li>
                <li className="flex items-start">
                  <span className="text-uswds-blue mr-2 mt-0.5">•</span>
