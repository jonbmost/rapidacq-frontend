...
import { Users, ArrowLeft, Send, Loader2, Download, Network } from 'lucide-react';
...
export default function StakeholderMappingPage() {
  ...
  const handleIntakeSkip = () => {
    setShowIntake(false);
    setMessages([{ role: 'assistant', content: 'Welcome to Stakeholder Mapping. I can help you identify key stakeholders, understand approval chains, and develop engagement strategies for your acquisition. What acquisition are you working on?' }]);
  };
  ...
  const intakeConfig = intakeConfigs['stakeholder-mapping'];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              <DownloadButtons messages={messages} toolContext="stakeholder-mapping" />
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg p-6">
              ...
              <ul className="space-y-3 text-sm text-slate-400">
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Program managers</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Contracting officers</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Legal counsel</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Finance/budget</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>End users</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Oversight offices</span></li>
              </ul>
            </div>
          </div>
