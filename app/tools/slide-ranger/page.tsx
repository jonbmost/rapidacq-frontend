...
export default function SlideRangerPage() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: 'Welcome to Slide Ranger. I can help you create professional acquisition briefings and presentations for leadership, stakeholders, and review boards. What presentation do you need?'
    }
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex items-center mt-4">
            ...
            <div>
              ...
              <p className="text-uswds-red-warm-10">Generate professional acquisition presentations</p>
            </div>
          </div>
        </div>
      </div>
