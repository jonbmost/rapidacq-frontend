...
export default function RequirementDocumentsPage() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: 'Welcome to the Requirement Documents tool. I can help you create Statements of Work (SOW), Performance Work Statements (PWS), and other requirement documents with FAR-compliant language and structure. What type of requirement document do you need?'
    }
  ]);
  ...
  const exportConversation = () => {
    ...
    a.href = url;
    a.download = 'requirement-document.txt';
    a.click();
  };
      ...
      <div className="bg-uswds-green text-white py-8">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex items-center mt-4">
            ...
            <div>
              <h1 className="text-3xl font-bold font-serif">Requirement Documents</h1>
              <p className="text-green-100">Generate SOWs, PWS, and performance requirements</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded border border-uswds-gray-30 p-6 sticky top-8">
              <h3 className="font-bold text-uswds-gray-90 mb-4">Document Types</h3>
              <ul className="space-y-3 text-sm text-uswds-gray-70">
                ...
                <li className="flex items-start">
                  <span className="text-uswds-green mr-2">•</span>
                  <span>Deliverables and acceptance criteria</span>
                </li>
                <li className="flex items-start">
                  <span className="text-uswds-green mr-2">•</span>
                  <span>FAR-compliant language</span>
                </li>
              </ul>
              ...
              <form onSubmit={handleSubmit} className="p-4 border-t border-uswds-gray-30">
                <div className="flex space-x-2">
                  <input
                    ...
                    placeholder="What requirements do you need to document?"
