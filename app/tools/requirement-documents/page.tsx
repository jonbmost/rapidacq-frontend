...
export default function RequirementDocumentsPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: 'Welcome to Requirement Documents. I can help you draft SOWs, PWSs, and requirement summaries tailored to your acquisition. What are you trying to procure?'
    }
  ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await api.callMcpTool('requirement-documents', {
        message: userMessage,
        history: messages
      });
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex items-center mt-4">
            ...
            <div>
              ...
              <p className="text-blue-100">Generate SOWs, PWSs, and requirement statements</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded border border-uswds-gray-30 p-6 sticky top-8">
              <h3 className="font-bold text-uswds-gray-90 mb-4">Document Elements</h3>
              <ul className="space-y-3 text-sm text-uswds-gray-70">
                ...
                <li className="flex items-start">
                  <span className="text-uswds-blue mr-2">•</span>
                  <span>Standards and constraints</span>
                </li>
                <li className="flex items-start">
                  <span className="text-uswds-blue mr-2">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-uswds-blue mr-2">•</span>
                  <span>Government-furnished property</span>
                </li>
                <li className="flex items-start">
                  <span className="text-uswds-blue mr-2">•</span>
              ...
              <form onSubmit={handleSubmit} className="p-4 border-t border-uswds-gray-30">
                <div className="flex space-x-2">
                  <input
                    ...
                    placeholder="Describe the requirement you need documented..."
