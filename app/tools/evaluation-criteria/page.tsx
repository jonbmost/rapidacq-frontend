...
import { CheckSquare, ArrowLeft, Send, Loader2, Download, ListChecks } from 'lucide-react';
...
export default function EvaluationCriteriaPage() {
  ...
  const handleIntakeSkip = () => {
    setShowIntake(false);
    setMessages([{ role: 'assistant', content: 'Welcome to Evaluation Criteria. I can help you develop evaluation factors, scoring criteria, and source selection approaches. What type of evaluation criteria do you need?' }]);
  };
  ...
  const intakeConfig = intakeConfigs['evaluation-criteria'];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              <DownloadButtons messages={messages} toolContext="evaluation-criteria" />
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg p-6">
              ...
              <ul className="space-y-3 text-sm text-slate-400">
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Evaluation factors</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Subfactors & weights</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Rating scales</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Technical evaluation</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Past performance</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Price/cost analysis</span></li>
              </ul>
            </div>
          </div>
