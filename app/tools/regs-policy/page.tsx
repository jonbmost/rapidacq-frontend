...
import { BookOpen, ArrowLeft, Send, Loader2, Download, ScrollText } from 'lucide-react';
...
export default function RegsPolicyPage() {
  ...
  const handleIntakeSkip = () => {
    setShowIntake(false);
    setMessages([{ role: 'assistant', content: 'Welcome to Regs & Policy. I can help you navigate FAR, DFARS, agency supplements, and acquisition policy. I can also search for recent executive orders, policy memos, and regulatory updates. What regulation or policy question do you have?' }]);
  };
  ...
  const exportConversation = () => {
    ...
    a.href = url;
    a.download = 'regs-policy.txt';
    a.click();
  };

  const intakeConfig = intakeConfigs['regs-policy'];
          ...
          <div className="lg:col-span-1">
            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg p-6 sticky top-8">
              ...
              <ul className="space-y-3 text-sm text-slate-400">
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>FAR (all agencies)</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>DFARS (DoD)</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>GSAM/GSAR (GSA)</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Executive Orders</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>OMB Memoranda</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>OFPP Guidance</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Agency supplements</span></li>
              </ul>
            </div>
          </div>
              ...
              <form onSubmit={handleSubmit} className="p-4 border-t border-slate-700 bg-[#1e293b]">
                <div className="flex space-x-3">
                  <input
                    ...
                    placeholder="Ask about regulations, policy, or recent guidance..."
