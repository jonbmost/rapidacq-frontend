...
import { BookOpen, ArrowLeft, Send, Loader2, Download, Scale } from 'lucide-react';
...
export default function RegsPolicyPage() {
  ...
  const handleIntakeSkip = () => {
    setShowIntake(false);
    setMessages([{ role: 'assistant', content: 'Welcome to Regs & Policy. I can help you understand FAR, DFARS, agency supplements, and policy guidance. I can also search for recent policy updates and executive orders. What regulation or policy do you need help with?' }]);
  };
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg p-6">
              ...
              <ul className="space-y-3 text-sm text-slate-400">
                ...
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>GSAM (GSA)</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>AIDAR (USAID)</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>OMB Circulars</span></li>
