...
export default function MarketAnalysisPage() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: 'Welcome to the Market Analysis tool. I can help you conduct market research, analyze vendor capabilities, assess competition, and develop sources sought strategies. What market are you analyzing?'
    }
  ]);
