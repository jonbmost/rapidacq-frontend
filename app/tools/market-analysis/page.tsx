...
import { TrendingUp, ArrowLeft, Send, Loader2, Download, Search } from 'lucide-react';
...
export default function MarketAnalysisPage() {
  ...
  const handleIntakeSkip = () => {
    setShowIntake(false);
    setMessages([{ role: 'assistant', content: 'Welcome to Market Analysis. I can help you conduct market research, identify potential sources, analyze industry capabilities, and determine appropriate set-aside strategies. What market are you researching?' }]);
  };
  ...
  const intakeConfig = intakeConfigs['market-analysis'];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              <DownloadButtons messages={messages} toolContext="market-analysis" />
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg p-6">
              ...
              <ul className="space-y-3 text-sm text-slate-400">
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Industry capabilities</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Vendor identification</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Small business sources</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Pricing trends</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Commercial availability</span></li>
                <li className="flex items-start"><span className="text-blue-500 mr-2 mt-0.5">•</span><span>Competition analysis</span></li>
              </ul>
            </div>
          </div>
